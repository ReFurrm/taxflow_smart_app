      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center gap-3">
            ...
            <div>
              <Link to="/" className="text-2xl font-heading font-bold text-teal">TaxFlow</Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            {!user ? (
              <>
                ...
                <Link to="/login"><Button variant="ghost" className="text-charcoal hover:text-teal">Login</Button></Link>
                <Link to="/signup"><Button className="bg-teal hover:bg-teal-dark text-charcoal font-semibold">Sign Up</Button></Link>
              </>
            ) : (
              <>
                ...
                <Link to="/profile"><Button variant="ghost" className="text-charcoal hover:text-teal"><User className="h-4 w-4 mr-2" />Profile</Button></Link>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1">
            {!user ? (
              <>
                ...
                <Link to="/signup" onClick={() => setMobileMenuOpen(false)}><Button className="w-full">Sign Up</Button></Link>
              </>
            ) : (
              <>
                {protectedLinks.map(link => (
                ...
                <Link to="/profile" onClick={() => setMobileMenuOpen(false)}><Button variant="ghost" className="w-full justify-start"><User className="h-4 w-4 mr-2" />Profile</Button></Link>
